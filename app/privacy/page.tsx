export default function PrivacyPage() {
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '80px 48px 120px', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '48px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '16px' }}>Privacy Policy</h1>
      ...
      <div style={{ padding: '40px', borderRadius: '16px', background: 'var(--bg-secondary)', border: '1px solid var(--border)', textAlign: 'center' as const }}>
        ...
        <p style={{ fontSize: '14px', color: 'var(--text-muted)', lineHeight: '1.7' }}>
          Our Privacy Policy is being prepared and will be published here before launch. We are committed to protecting your personal information and being transparent about how we use it.
        </p>
      </div>
    </div>
  )
